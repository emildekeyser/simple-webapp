...
public class TestTable
{
	...
	public void setUp()
	{
		...
		driver.get("http://localhost:8080/r0599128_JSP_Vakken");
	}
	...
	{
		ArrayList<WebElement> th = (ArrayList<WebElement>) driver
	...
	{
		ArrayList<WebElement> td = (ArrayList<WebElement>) driver
				.findElements(By.tagName("td"));
		int teller = 0;
		for (Vak vak : vakken)
		{
			assertEquals(vak.getNaam(), td.get(teller * 3).getText());
			assertEquals(vak.getStudiePunten(),
					Integer.parseInt(td.get(teller * 3 + 1).getText()));
